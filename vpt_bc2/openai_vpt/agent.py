...
class MineRLAgent:
    ...
    def _env_action_to_agent(self, minerl_action_transformed, to_torch=False, check_if_null=False):
        ...
        """
        print("_env_action_to_agent minerl_action_transformed:", minerl_action_transformed)

        minerl_action = self.action_transformer.env2policy(minerl_action_transformed)

        print("_env_action_to_agent minerl_action :", minerl_action)
        if check_if_null:
        ...
        print("_env_action_to_agent action: ", action)
        if to_torch:
    ...
    def get_action(self, minerl_obs):
        ...
        call `reset()`.
        """
        print("agent.py get_action minerl_obs: ", minerl_obs)
        agent_input = self._env_obs_to_agent(minerl_obs)
        print("agent.py get_action agent_input: ", agent_input)
        ...
        print("agent.py get_action agent_action: ", agent_action)
        minerl_action = self._agent_action_to_env(agent_action)
        print("agent.py get_action minerl_action: ", minerl_action)
